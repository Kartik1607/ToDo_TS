...
var ToDoRepository = /** @class */ (function () {
    ...
    ToDoRepository.prototype.getAllItems = function () {
        return this.items;
    };
...
window.App.handleActiveCheckboxClick = function (checkBox) {
    ui_1.default.handleActiveCheckboxClick(checkBox);
};
window.App.onComplete = function () {
    ui_1.default.onComplete();
};
window.App.onDeleteActive = function () {
    ui_1.default.onDeleteActive();
};
window.App.handleCompleteCheckboxClick = function (checkBox) {
    ui_1.default.handleCompleteCheckboxClick(checkBox);
};
window.App.onActivate = function () {
    ui_1.default.onActivate();
};
window.App.onDeleteComplete = function () {
    ui_1.default.onDeleteComplete();
};
window.App.onToDoEdit = function (id, value) {
    ToDoRepository_1.default.editElement(id, value);
...
//VISIBILITY STATE
var STATE_HIDDEN = 'visibility:hidden;';
var STATE_VISIBLE = '';
var STATE_GONE = 'display : none;';
var LISTACTIVE_HTML_HEAD = '<li style="background: GREEN; color: white"><b>ACTIVE</b></li>';
var LISTCOMPLETE_HTML_HEAD = "<li style='background: BLACK; color: white'>\n                                    <b>COMPLETED</b>\n                                </li>";
var LISTDELETED_HTML_HEAD = "<li style='background: RED; color: white'>\n                                    <b>DELETED</b>\n                                </li>";
...
var buttonsActive = document.getElementById(BUTTONS_ACTIVE);
var buttonsComplete = document.getElementById(BUTTONS_COMPLETE);
var UI = /** @class */ (function () {
    ...
    UI.prototype.handleActiveCheckboxClick = function (checkBox) {
        var item = checkBox;
        if (item.checked) {
    ...
    UI.prototype.handleCompleteCheckboxClick = function (checkBox) {
        var item = checkBox;
        if (item.checked) {
    ...
    UI.prototype.onDeleteActive = function () {
        var elements = ListActive.getElementsByTagName('input');
        for (var index = 0; index < elements.length; ++index) {
            var current = elements.item(index);
            if (!current.checked) {
                continue;
            }
            var id = Number(current.getAttribute(ATTR_ID));
            ToDoRepository_1.default.removeItem(id);
        }
        this.refreshList();
        buttonsActive.setAttribute(ATTR_STYLE, STATE_HIDDEN);
    };
    UI.prototype.onDeleteComplete = function () {
        var elements = ListCompleted.getElementsByTagName('input');
        for (var index = 0; index < elements.length; ++index) {
            var current = elements.item(index);
            if (!current.checked) {
                continue;
    ...
    UI.prototype.onComplete = function () {
        var elements = ListActive.getElementsByTagName('input');
        for (var index = 0; index < elements.length; ++index) {
            var current = elements.item(index);
            if (!current.checked) {
            ...
            var id = Number(current.getAttribute(ATTR_ID));
            ToDoRepository_1.default.completeItem(id);
        }
        this.refreshList();
        buttonsActive.setAttribute(ATTR_STYLE, STATE_HIDDEN);
    };
    UI.prototype.onActivate = function () {
        var elements = ListCompleted.getElementsByTagName('input');
        for (var index = 0; index < elements.length; ++index) {
            var current = elements.item(index);
            if (!current.checked) {
            ...
            var id = Number(current.getAttribute(ATTR_ID));
            ToDoRepository_1.default.activateItem(id);
        }
        this.refreshList();
        buttonsComplete.setAttribute(ATTR_STYLE, STATE_HIDDEN);
    };
    UI.prototype.refreshList = function () {
        ...
        var items = ToDoRepository_1.default.getAllItems();
